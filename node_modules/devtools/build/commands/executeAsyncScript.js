...
async function executeAsyncScript({
  ...
  const result = await page.$eval('html', _executeAsyncScript.default, script, scriptTimeout, _constants.SERIALIZE_PROPERTY, _constants.SERIALIZE_FLAG, ...(await _utils.transformExecuteArgs.call(this, args)));
