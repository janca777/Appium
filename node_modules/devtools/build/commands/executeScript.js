...
async function executeScript({
  ...
  const executePromise = page.$eval('html', _executeScript.default, script, _constants.SERIALIZE_PROPERTY, _constants.SERIALIZE_FLAG, ...(await _utils.transformExecuteArgs.call(this, args)));
  let executeTimeout;
