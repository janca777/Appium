...
class CucumberAdapter {
  ...
  addWdioHooks(config) {
    Cucumber.Before(function wdioHookBeforeScenario(world) {
      ...
      return (0, _utils.executeHooksWithArgs)(config.beforeScenario, [uri, feature, world.pickle, world.sourceLocation, world]);
    });
    Cucumber.After(function wdioHookAfterScenario(world) {
      ...
      return (0, _utils.executeHooksWithArgs)(config.afterScenario, [uri, feature, world.pickle, world.result, world.sourceLocation, world]);
    });
